...
static int wl12xx_irq_locked(struct wl1271 *wl)
{
	...
	while (!done && loopcount--) {
		...
		if (likely(intr & WL1271_ACX_INTR_DATA)) {
			...
			printk("[WLAN] %s WL1271_ACX_INTR_DATA\n", __func__);
#endif
...
#ifdef HTC_WAKE_DEBUG
			printk("[WLAN] %s WL1271_ACX_INTR_EVENT_A\n", __func__);
#endif
...
#ifdef HTC_WAKE_DEBUG
			printk("[WLAN] %s WL1271_ACX_INTR_EVENT_B\n", __func__);
#endif
...
#ifdef HTC_WAKE_DEBUG
			printk("[WLAN] %s WL1271_ACX_INTR_INIT_COMPLETE\n", __func__);
#endif
...
#ifdef HTC_WAKE_DEBUG
			printk("[WLAN] %s WL1271_ACX_INTR_HW_AVAILABLE\n", __func__);
#endif
